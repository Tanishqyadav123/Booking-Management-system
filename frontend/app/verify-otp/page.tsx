    ...
    const verifyOtp = async(data : verifyOtpSchemaType) =>{
          ...
          try {
            ...
            if (!localStorage.getItem("phoneNumber")) {
             ...
             await verifyOtpService({otp : data.otp , phoneNumber : localStorage.getItem("phoneNumber")! , codeType : "VERIFY"})
  ...
  return (
    ...
    <div className='w-full h-screen  bg-gray-300 flex text-black items-center justify-center'>
        ...
        <div className='w-[30%] min-h-[60%] bg-white p-5'>
             ...
             <form onSubmit={handleSubmit(verifyOtp)} className=' mt-12 flex items-center flex-col gap-4'>
              
                 <Input inputType='text' placeHolder="Enter OTP" register = {register("otp")} error={errors.otp?.message}  />

                 
                 <DarkButton isDisabled = {loading ? true : false}  btnText={loading ? "verifying..."  : "verify"} type='submit'/>
